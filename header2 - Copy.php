...
<nav class="navbar navbar-default">
  <div class="container-fluid">
    <div class="navbar-header col-md-2">
      ...
      <a class="navbar-brand" href="/cmsweb/">Drupal</a>
    </div>
    <div class="collapse navbar-collapse" id="myNavbar">
      ...
      <?php if($user->is_loggedin()){ ?>
        <li class="dropdown">
          <a href="#" class="dropdown-toggle glyphicon glyphicon-dashboard" data-toggle="dropdown"  role="button" aria-expanded="false">&nbsp; Dashboard <span class="caret"></span></a>
...
if (isset($accessToken)) {
  ...
  ?>
  <li><a href="/cmsweb/user/dashbord.php">Welcome  &nbsp; <span class="glyphicon glyphicon-user"></span> &nbsp;  <?php echo $userNode->getName();?>
  </a></li>
